package com.example.rh.ui.animation;
...
import com.example.rh.ui.dimen.ScreenUtils;


public final class BezierAnimation {

    public static void addCart(BaseAppFragment delegate, View start, View end,
        ...
        final ViewGroup anim_mask_layout = BezierUtil.createAnimLayout(delegate.getActivity());
